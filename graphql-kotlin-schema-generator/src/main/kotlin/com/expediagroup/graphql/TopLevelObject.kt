 ...
 */
class TopLevelObject<in Context : GraphQLContext>(private val targetFactory: (context: Context) -> Any?, val kClass: KClass<*>) {
    constructor(obj: Any) : this(obj, obj::class)
    constructor(kClass: KClass<*>) : this({ null }, kClass)
    constructor(obj: Any, kClass: KClass<*>) : this({ obj }, kClass)

    fun getTarget(context: Context): Any? = targetFactory(context)
}
